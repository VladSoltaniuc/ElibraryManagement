...
namespace ElibraryManagement
{
    public partial class adminmembermanagement : System.Web.UI.Page
    {
        ...
        //Get member info from the Database
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            getMemberByID();
        }

        //Change status to ACTIVE member account
        ...
        //Change status to PENDING member account
        ...
        //Change status to DISABLED member account
