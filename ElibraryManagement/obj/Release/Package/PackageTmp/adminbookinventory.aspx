                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="form-control btn btn-primary" align="left" ID="LinkButton4" runat="server" OnClick="LinkButton4_Click"><i class="fas fa-check-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-9">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList2" runat="server">
                              <asp:ListItem >Teora</asp:ListItem>
                              <asp:ListItem >Amazing Reads</asp:ListItem>
                           </asp:DropDownList>
                        </div>
                     </div>
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList3" runat="server">
                              <asp:ListItem >Joseph Murphy</asp:ListItem>
                              <asp:ListItem >Dale Carnegie</asp:ListItem>
                               <asp:ListItem>Napoleon Hill</asp:ListItem>
                           </asp:DropDownList>
                        </div>
